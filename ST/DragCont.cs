...
namespace ST
{   //Полностью и честно взятый метод из инетрнета для переноса формы или панели мышкой (DragControl)
    class DragCont : Component
    {
        ...
        private void DragForm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (flag)
            {
                DragCont.ReleaseCapture();
                DragCont.SendMessage(this.SelectControl.FindForm().Handle, 161, 2, 0);
            }
        }
    }
}
